...
void usage(const char* progname) {
    ...
    printf("Valid scenenames are: rgb, rgby, rand10k, rand100k, biglittle, littlebig, pattern, bouncing, hypnosis, fireworks, snow, snowsingle\n");
...
int main(int argc, char** argv)
{
    ...
    if (checkCorrectness) {
        ...
        if (benchmarkFrameStart >= 0)
            ...
            //Only in case we can use glut library.
            //glutInit(&argc, argv);
